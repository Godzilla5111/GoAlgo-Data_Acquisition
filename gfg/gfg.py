...
titles=titles[:-1:]
corpus = set()
for i in range(6634-6380,len(urls)):
    all = []
    url = urls[i]
    title = titles[i]
    driver.get(url);
    ...
    question_file = open('C:/Users/ANURAG SINGH/Desktop/IIT KGP/Semesters/SEM-5/AI61005/assignment/gfg/questions/problem_'+str(6380+i)+'.html', 'w')
    ...
    text_file = open('C:/Users/ANURAG SINGH/Desktop/IIT KGP/Semesters/SEM-5/AI61005/assignment/gfg/text/problem_'+str(6380+i)+'.txt','w')
